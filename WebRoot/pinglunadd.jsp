        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="row">
						 ...
						 <form name="form1" method="post" action="pinglun_add_post.jsp">
                        <table width="98%" border="0" class="newsline" align="left" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                          <tr>
                            <td width="100">菜品ID：</td>
                            <td><input name='spid' type='text' id='spid' value='<%=spid%>' />
                              &nbsp;*</td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td><textarea name='neirong' cols='50' rows='15' id='neirong'></textarea></td>
                          </tr>
