...
<html>
  ...
  <body >
  <p>已有友情链接列表：</p>
  <form name="form1" id="form1" method="post" action="admin/youqinglianjie_list.jsp">
   搜索:网址:
...
%>
  <tr>
    ...
    <td><%=addtime %></td>
    <td><a href="admin/youqinglianjie_updt.jsp?id=<%=id%>">修改</a>  <a href="admin/del.jsp?id=<%=id %>&tablename=youqinglianjie" onClick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
