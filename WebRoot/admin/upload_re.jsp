	...
	try 
	{
		   ...
		   else 
		   {
               ...
               //{
				   ...
				   String saveurl = request.getSession().getServletContext().getRealPath("admin/upload");
...
<script language="javascript">
	...
	window.parent.document.getElementById(Result).value="admin/upload/<%= newFile1Name%>";					
