...
function check()
{
  ...
  <body >
  <form name="form1" id="form1" method="post" action="admin/yhzhgl_post.jsp">
...
%>
  <tr>
    ...
    <td><%=cx %></td>
    <td><%=addtime %></td>
    <td><a href="admin/del.jsp?id=<%=id %>&tablename=allusers" onclick="return confirm('真的要删除？')">删除</a></td>
  </tr>
  	<%
  }
   %>
