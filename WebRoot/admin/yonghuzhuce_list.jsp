...
<html>
  ...
  <form name="form1" id="form1" method="post" action="">
   搜索: 用户名：<input name="yonghuming" type="text" id="yonghuming" size="15" style='border:solid 1px #000000; color:#666666'/> 
   姓名：<input name="xingming" type="text" id="xingming" size="15" style='border:solid 1px #000000; color:#666666'/>
   电话：
   <input name="dianhua" type="text" id="dianhua" size="15" style='border:solid 1px #000000; color:#666666' /> 
   身份证：<input name="shenfenzheng" type="text" id="shenfenzheng" size="15" style='border:solid 1px #000000; color:#666666' />
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' />
</form>
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    <td width="106" align="center" bgcolor="CCFFFF">序号</td>
    <td width="143" bgcolor='#CCFFFF'>用户名</td>
    <td width="100" bgcolor='#CCFFFF'>密码</td>
    <td width="162" bgcolor='#CCFFFF'>姓名</td>
    <td width="142" bgcolor='#CCFFFF'>性别</td>
    <td width="146" bgcolor='#CCFFFF'>电话</td>
    <td width="185" bgcolor='#CCFFFF'>身份证</td>
    <td width="90" align="center" bgcolor="CCFFFF">审核</td>
    <td width="159" align="center" bgcolor="CCFFFF">操作</td>
  </tr>
  <%
  String sql;
  int curpage=1;//当前页
...
%>
  <tr>
	...
	<td><%=dianhua %></td>
	<td><%=shenfenzheng %></td>
	<td width="90" align="center"><a href="admin/sh.jsp?id=<%=id%>&yuan=<%=issh%>&tablename=yonghuzhuce" onClick="return confirm('确定要执行此操作？');"><%=issh%></a></td>
    <td width="159" align="center"><a href="admin/yonghuzhuce_updt.jsp?id=<%=id%>">修改</a>     <a href="admin/yonghuzhuce_detail.jsp?id=<%=id%>">详细</a>    <a href="admin/del.jsp?id=<%=id %>&tablename=yonghuzhuce" onClick="return confirm('真的要删除？')">删除</a> <a href="admin/yonghuzhuce_detail.jsp?id=<%=id%>" target="_blank"></a></td>
  </tr>
  	<%
  }
   %>
...
<p align="center">&nbsp;共<%=zgs%>条记录&nbsp;&nbsp;<%=page_record %>条/页　<a href="admin/yonghuzhuce_list.jsp?page=1">首页</a>　<a href="admin/yonghuzhuce_list.jsp?page=<%= curpage-1%>">上一页</a>　<A href="admin/yonghuzhuce_list.jsp?page=<%= curpage+1%>">下一页</A>　<a href="admin/yonghuzhuce_list.jsp?page=<%=zys %>">尾页</A>　当前第<FONT color=red><%=curpage %></FONT>页/共<FONT color=red><%=zys %></FONT>页</p>
  </body>
</html>
